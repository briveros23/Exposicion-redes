...
El método del vecino más cercano es una técnica simple pero efectiva para hacer predicciones basadas en los atributos de los nodos en una red. Este método se centra en utilizar la información de los nodos adyacentes (vecinos) para predecir el valor del atributo de un nodo específico, antes de entrar al metodo exploremos 3 conceptos claves. 
...
### 4.3 Regresión del kernel en grafos.
